...
if next_database_image:
  ...
  if len(diff_array) != 0:
    ...
    context.setPublicationSectionList(current_publication_section_list + ['publication_section/file_system_image/diff_end/identical'])

else:
  context.setPublicationSectionList(current_publication_section_list + ['publication_section/file_system_image/diff_end/different'])
