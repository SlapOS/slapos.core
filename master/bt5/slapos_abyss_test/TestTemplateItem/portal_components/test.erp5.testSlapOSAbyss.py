...
{"end_date": "2022/11/15 17:08 CET", "end_marker": "fluentbit_end"}\n'
  ...
  def test_data_transformation(self):
    ...
    ndarray_dict = {}
    for reference in request_dict:
      ndarray_dict[reference] = self.string_to_ndarray(reference, request_dict[reference])

    for compute_node in self.compute_node_list:
      data_array_list = self._getRelatedDataArrayList(compute_node)
      self.assertEqual(len(data_array_list),1)
      self.assertTrue(np.array_equal(data_array_list[0].array[:], ndarray_dict[compute_node.getReference()]))
  ...
  def test_data_processing_for_the_first_access(self):
    ...
    for compute_node in self.compute_node_list:
      ...
      data_array_list = self._getRelatedDataArrayList(compute_node)
      self.assertEqual(len(data_array_list), 1)
      self.assertEqual(data_array_list[0].getPublicationSectionList(), compute_node.getPublicationSectionList() + ['file_system_image/first_access'])
      self.assertEqual(data_array_list[0].getSimulationState(), 'converted')
    ...
    for compute_node in self.compute_node_list:
      ...
      self.assertEqual(len(data_array_list), 1)
      self.assertEqual(data_array_list[0].getPublicationSectionList(), compute_node.getPublicationSectionList() + ['file_system_image/first_access'])
      self.assertEqual(data_array_list[0].getSimulationState(), 'processed')
...
{"end_date": "2022/11/15 17:08 CET", "end_marker": "fluentbit_end"}\n'
    ...
    for compute_node in self.compute_node_list:
      ...
      self.assertEqual(data_array_list[-1].getSimulationState(), 'converted')
  ...
  def test_data_processing_for_sequence_data_ingestion(self):
    ...
    self.assertEqual(len(data_array_list), 2)
    self.assertEqual(data_array_list[0].getSimulationState(), 'archived')
    self.assertEqual(data_array_list[1].getSimulationState(), 'processed')
...
{"end_date": "2022/11/15 17:08 CET", "end_marker": "fluentbit_end"}\n'
    ...
    self.assertEqual(data_array_list[2].getSimulationState(), 'converted')
    self.portal.portal_alarms.slapos_process_data_array.activeSense()
    self.tic()
    data_array_list = self._getRelatedDataArrayList(self.portal.compute_node_module['node_debian10'])
    self.assertEqual(len(data_array_list), 4)
    self.assertEqual(data_array_list[0].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[1].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[2].getSimulationState(), 'processed')
    # array 3 is the result of array 0 and array 2, Note: array 0 is the first access data
    self.assertEqual(data_array_list[3].getSimulationState(), 'converted')
    ...
    self.assertEqual(data_array_list[1].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[2].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[3].getSimulationState(), 'processed')
    # array 4 is result of array 3 and database_debian10
    self.assertEqual(data_array_list[4].getSimulationState(), 'converted')
    ...
    self.assertEqual(data_array_list[2].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[3].getSimulationState(), 'processed')
    self.assertEqual(data_array_list[4].getSimulationState(), 'processed')
    # array 5 is result of array 4 and database_debian11
    self.assertEqual(data_array_list[5].getSimulationState(), 'converted')
    ...
    self.portal.portal_alarms.slapos_process_data_array.activeSense()
    self.tic()
    self.assertEqual(data_array_list[5].getSimulationState(), 'processed')
...
{"end_date": "2022/11/15 17:08 CET", "end_marker": "fluentbit_end"}\n'
  ...
  def test_data_processing_check_value_in_data_array(self):
    ...
    tmp_data_array.setPublicationSectionList(['file_system_image/distribution/test_distribution/debian10', 'file_system_image/first_access'])
    tmp_data_array.convertFile()
    tmp_data_array.processFile()

    tmp_data_array = self.portal.data_array_module.newContent(portal_type='Data Array', title='first_access_data')
    tmp_data_array.setCausality('compute_node_module/node_debian11')
    tmp_data_array.initArray(shape=(0,), dtype='int64')
    tmp_data_array.setArray([])
    tmp_data_array.setPublicationSectionList(['file_system_image/distribution/test_distribution/debian11', 'file_system_image/first_access'])
    tmp_data_array.convertFile()
    tmp_data_array.processFile()
    self.tic()
