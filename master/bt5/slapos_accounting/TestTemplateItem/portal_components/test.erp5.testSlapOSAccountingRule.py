...
class TestHostingSubscriptionSimulation(SlapOSTestCaseMixin):
  __open_order_portal_type = 'Open Sale Order'
  __open_order_line_portal_type = 'Open Sale Order Line'
  __subscription_item_portal_type = 'Hosting Subscription'
  ...
  def _prepare(self):
    ...
    open_order = self.portal.getDefaultModule(portal_type=self.__open_order_portal_type).newContent(
    ...
    self.subscription = self.portal.getDefaultModule(portal_type=self.__subscription_item_portal_type).newContent(
      portal_type=self.__subscription_item_portal_type,
      periodicity_hour=0,
    ...
    self.open_order_line = open_order.newContent(
      portal_type=self.__open_order_line_portal_type,
      resource_value=resource,
...
class TestConsumptionSubscriptionSimulation(TestHostingSubscriptionSimulation):
  __open_order_portal_type = 'Open Internal Order'
  __open_order_line_portal_type = 'Open Internal Order Line'
  __subscription_item_portal_type = 'Consumption Subscription'
