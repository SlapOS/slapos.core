...
class TestSlapOSReferenceConstraint(TestSlapOSConstraintMixin):
  ...
  def test_reference_not_empty_instance_tree(self):
    self._test_reference_not_empty(
      self.portal.instance_tree_module.newContent(portal_type='Instance Tree'))
  ...
  def test_reference_unique_instance_tree(self):
    module = self.portal.instance_tree_module
    self._test_reference_unique(
      module.newContent(portal_type='Instance Tree', reference=self.generateNewId()),
      module.newContent(portal_type='Instance Tree', reference=self.generateNewId()))
