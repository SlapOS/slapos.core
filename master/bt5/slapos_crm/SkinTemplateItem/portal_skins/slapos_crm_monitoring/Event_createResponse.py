"""
Custom script for SlapOS, all responses are created based on 
the expected configuration of ticket, always from administrator to customer.

"""
portal = context.getPortalObject()
module = portal.getDefaultModule(response_event_portal_type)

if context.getFollowUpList():
  ticket = context.getFollowUpList()[0]
  source = ticket.getSourceSection()
