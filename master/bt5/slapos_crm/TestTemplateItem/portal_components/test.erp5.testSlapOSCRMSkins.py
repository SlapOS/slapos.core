...
class TestTicket_createProjectEvent(TestCRMSkinsMixin):
  ...
  def test_Ticket_createProjectEvent_incomingEventWithoutAttachment(self):
    ...
    self.assertEqual(event.getPortalType(), 'Letter')
    self.assertEqual(event.getTitle(), 'foo_title')
    self.assertEqual(event.getFollowUp(), ticket.getRelativeUrl())
    self.assertEqual(event.getResource(), 'foo resource')
    self.assertEqual(event.getSource(), ticket.getDestination())
    self.assertEqual(event.getSourceSection(), ticket.getDestinationSection())
    self.assertEqual(event.getSourceProject(), ticket.getDestinationProject())
    self.assertEqual(event.getDestination(), ticket.getSource())
    self.assertEqual(event.getDestinationSection(), ticket.getSourceSection())
    self.assertEqual(event.getDestinationProject(), ticket.getSourceProject())
    self.assertEqual(event.getTextContent(), 'foo text')
  ...
  def test_Ticket_createProjectEvent_incomingEventWithoutAttachmentAndNotificationMessage(self):
    ...
    self.assertEqual(event.getPortalType(), 'Letter')
    self.assertEqual(event.getTitle(), notification_message.getTitle())
    self.assertEqual(event.getFollowUp(), ticket.getRelativeUrl())
    self.assertEqual(event.getResource(), 'foo resource')
    self.assertEqual(event.getSource(), ticket.getDestination())
    self.assertEqual(event.getSourceSection(), ticket.getDestinationSection())
    ...
    self.assertEqual(event.getDestinationSection(), ticket.getSourceSection())
    self.assertEqual(event.getDestinationProject(), ticket.getSourceProject())
    self.assertEqual(event.getTextContent(), notification_message.getTextContent())
    self.assertEqual(event.getContentType(), notification_message.getContentType())
    self.assertSameEventAttachmentList(event)
    self.assertEqual(event.getSimulationState(), 'stopped')
  ...
  def test_Ticket_createProjectEvent_incomingEventWithSourceAndDestination(self):
    ...
    self.assertEqual(event.getFollowUp(), ticket.getRelativeUrl())
    self.assertEqual(event.getResource(), 'foo resource')
    self.assertEqual(event.getSource(), source_value.getRelativeUrl())
    self.assertEqual(event.getSourceSection(), ticket.getDestinationSection())
    self.assertEqual(event.getSourceProject(), ticket.getDestinationProject())
    self.assertEqual(event.getDestination(), destination_value.getRelativeUrl())
    self.assertEqual(event.getDestinationSection(), ticket.getSourceSection())
    self.assertEqual(event.getDestinationProject(), ticket.getSourceProject())
    self.assertEqual(event.getTextContent(), 'foo text')
    self.assertEqual(event.getContentType(), 'text/plain')
  ...
  def test_Ticket_createProjectEvent_outgoingEvent(self):
    ...
    self.assertEqual(event.getFollowUp(), ticket.getRelativeUrl())
    self.assertEqual(event.getResource(), 'foo resource')
    self.assertEqual(event.getDestination(), ticket.getDestination())
    self.assertEqual(event.getDestinationSection(), ticket.getDestinationSection())
    self.assertEqual(event.getDestinationProject(), ticket.getDestinationProject())
    self.assertEqual(event.getSource(), ticket.getSource())
    self.assertEqual(event.getSourceSection(), ticket.getSourceSection())
    self.assertEqual(event.getSourceProject(), ticket.getSourceProject())
    self.assertEqual(event.getTextContent(), 'foo text')
    self.assertEqual(event.getContentType(), 'text/plain')
    self.assertSameEventAttachmentList(event)
