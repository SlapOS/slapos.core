  ...
  class TestSlapOSCodingStyle(CodingStyleTestCase, SlapOSTestCaseMixin):
    ...
    def afterSetUp(self):
      ...
      CodingStyleTestCase.coverage_ignore_path_list = [
        ...
        'slapos_cloud/Base_updateRelatedContentWithoutReindextion',
        'slapos_cloud/ComputerPartition_checkComputePartitionMigrationConsistency',
        'slapos_cloud/Computer_checkComputeNodeMigrationConsistency',
        'slapos_cloud/HostingSubscription_checkInstanceTreeMigrationConsistency',
        ...
        'slapos_cloud/Person_getAssigmentPlaceholderEntityUidList',
        'slapos_cloud/Project_getUserWorkgroup',
        'slapos_cloud/Base_isEntityProjectCustomer',
        ...
        'slapos_json_rpc_api/ComputeNode_validateTioXMLAndExtractReference',
        ...
        'slapos_upgrader/AlarmTool_checkSaleTradeConditionEmptyReferenceMigrationConsistency',
        ...
        'slapos_slap_tool/ERP5Workflow_activateFillComputeNodeInformationCache',
        'slapos_slap_tool/ERP5Workflow_reindexComputePartition',
        ...
        'slapos_administration/Base_checkConsistencyAsUser',
        'slapos_administration/Base_getAllowedRolesAndUsers',
        'slapos_administration/Base_getSecurityUidDictAndRoleColumnDictForUser',
        'slapos_administration/Base_getSlapOSattr',
        'slapos_administration/ERP5Site_getSecurityUidListForRecreateTable',
        ...
        'slapos_base/Login_unrestrictedSearchAuthenticationEvent',
        'slapos_base/Login_unrestrictedSearchPasswordEvent',
        ...
        'slapos_panel/Folder_modifyDocumentListStatusFromSlaposPanel',
        ...
        'slapos_panel/Module_getWorkflowTransitionDialogIdFromSlaposPanel',
        'slapos_panel/Module_listWorkflowTransitionItemFromSlaposPanelList',
        ...
        'slapos_panel/AssignmentRequest_testNameConflictBeforeSubmit',
        'slapos_panel_compatibility/Base_getComputerToken',
        ...
        'slapos_web_renderjs_ui/CredentialRequest_checkEmailAvailability',
        ...
        'slapos_web_renderjs_ui/ERP5Site_unrestrictedSearchMessage',
        ...
        'slapos_subscription_request/AssignmentRequest_claimSubscriptionRequestToWorkgroup',
        'slapos_subscription_request/AssignmentRequest_suspendDuplicatedAssignmentRequest',
        'slapos_subscription_request/RemoteNodeChangeRequest_init',
        'slapos_subscription_request/RemoteNodeChangeRequest_validateIfSubmitted',
        ...
        'slapos_upgrader/ComputerConsumptionTioXMLFile_migrateConsumptionDocumentWorkflowHistory',
        'slapos_rss_style/Base_convertToSafeXML',
    ...
    def test_PythonScriptTestCoverage(self):
      ...
      for skin_id in skin_id_set:
        ...
        for _, document in skin.ZopeFind(
            skin,
            obj_metatypes=('Script (Python)', 'Z SQL Method', 'External Method'),
            search_sub=True):
...
def test_suite():
  ...
  for _, bt in portal_templates.resolveBusinessTemplateListDependency(dependency_list):
    if not bt.startswith('erp5_') or bt.startswith("erp5_interaction_drop"):
      suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(makeTestSlapOSCodingStyleTestCase(bt)))

  suite.addTest(unittest.defaultTestLoader.loadTestsFromTestCase(makeTestSlapOSCodingStyleTestCase('slapos_erp5')))
  return suite
