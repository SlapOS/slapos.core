  ...
  class TestSlapOSCodingStyle(CodingStyleTestCase, SlapOSTestCaseMixin):
    ...
    def afterSetUp(self):
      ...
      CodingStyleTestCase.coverage_ignore_path_list = [
        ...
        'slapos_accounting/OpenInternalOrderCell_asPredicate',
        'slapos_accounting/OpenInternalOrderLine_asPredicate',
        'slapos_accounting/OpenInternalOrder_asPredicate',
        'slapos_accounting/OpenSaleOrderCell_asPredicate',
        'slapos_accounting/OpenSaleOrderLine_asPredicate',
        'slapos_accounting/OpenSaleOrder_asPredicate',
        ...
        'slapos_panel/Workgroup_claimSlaposMemberInstanceAction',
