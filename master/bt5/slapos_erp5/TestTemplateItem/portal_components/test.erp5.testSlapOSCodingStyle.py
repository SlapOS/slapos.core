  ...
  class TestSlapOSCodingStyle(CodingStyleTestCase, SlapOSTestCaseMixin):
    ...
    def afterSetUp(self):
      ...
      CodingStyleTestCase.coverage_ignore_path_list = [
        ...
        'slapos_json_rpc_api/ComputeNode_approveComputer',
        'slapos_json_rpc_api/JSONRPCService_asJSONText',
        'slapos_json_rpc_api/JSONRPCService_createComputeNode',
        ...
        'slapos_json_rpc_api/JSONRPCService_searchComputeNode',
        'slapos_json_rpc_api/JSONRPCService_searchInstance',
        'slapos_json_rpc_api/JSONRPCService_searchSoftwareInstallation',
        'slapos_json_rpc_api/JSONRPCService_updateComputeNodeFromAPIDict',
        'slapos_json_rpc_api/JSONRPCService_updateSoftwareInstallationFromDict',
        'slapos_json_rpc_api/JSONRPCService_updateSoftwareInstanceFromDict',
