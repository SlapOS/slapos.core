  ...
  class TestSlapOSCodingStyle(CodingStyleTestCase, SlapOSTestCaseMixin):
    ...
    def afterSetUp(self):
      ...
      CodingStyleTestCase.coverage_ignore_path_list = [
        ...
        'slapos_cloud/Base_castDictToXMLString',
        'slapos_cloud/Base_getTransactionalTag',
        'slapos_cloud/Base_setTransactionalTag',
        ...
        'slapos_cloud/SoftwareInstance_bangAsSelf',
