...
(function (window, document, rJS, RSVP, Node, domsugar) {
  ...
  rJS(window)
          ...
          .push(function () {
            return RSVP.hash({
              url_list: gadget.getUrlForList([
                ...
                {command: 'display', options: {page: "slap_project_list", editable: true}},
    ...
    .declareJob("calculateContextualHelpList", function (jio_key) {
      var context = this,
        queue = new RSVP.Queue(),
        slapos_panel_extra_menu = context.element.querySelector(".slapos_panel_extra_menu"),
        contextual_help_dl = domsugar('dl', {"class": "dl-contextual-help"});
      return queue
        .push(function () {
        ...
        .push(function (contextual_help_list) {
          ...
          if (contextual_help_list.length > 0) {
            if (document.querySelector('.contextual-help-link') === null) {
              contextual_help_dl.appendChild(domsugar("dt",
                {
              ...
              for (i = 0; i < contextual_help_list.lenght; i += 1) {
                contextual_help_dl.appendChild(
              ...
              slapos_panel_extra_menu.appendChild(contextual_help_dl);
            }
          }
          return contextual_help_list;
        });
    })
      ...
      return queue
        ...
        .push(function (result_list) {
          ...
          if (attention_point_list.length > 0) {
            if (document.querySelector('.attention-point-link') === null) {
              attention_point_ul.innerHTML = domsugar(
                "li",
                {},
                [
                  domsugar("a",
