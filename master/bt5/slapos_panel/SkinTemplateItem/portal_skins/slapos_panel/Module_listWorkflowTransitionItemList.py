...
if module.getPortalType() == 'Support Request Module':
  ...
  result['form_id_dict']['UpgradeDecision_acceptOnSlaposPanel'] = 'Base_renderEmptyDialog'
  ...
  result['form_id_dict']['UpgradeDecision_rejectOnSlaposPanel'] = 'Base_renderEmptyDialog'
  result['listbox_parameter_dict']['Ticket_addSlapOSEvent'] = [('simulation_state', ['confirmed']), ('local_roles', ['Assignee', 'Assignor'])]
