...
setup(name=name,
      ...
      entry_points={
        ...
        'slapos.cli': [
          ...
          'compute node list = slapos.cli.compute_node_list:ListCommand',
          'compute node info = slapos.cli.compute_node_info:InfoCommand',
          'compute node token = slapos.cli.compute_node_token:TokenCommand',
