...
def forwardRequestToExternalMaster(master_url, request_form):
  ...
  partition_id = unicode2str(request_form.get('computer_partition_id', 'user'))
  partition_reference = '%s_%s' % (partition_id, unicode2str(request_form['partition_reference']))
