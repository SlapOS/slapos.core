...
class RotateLogTestCase(unittest.TestCase):
  ...
  def test_rotate_log(self):
    ...
    self.create_file(log_file + '.2', 200, 1500)
    self.create_file(log_file + '.3', 300, 1500)
  ...
  def test_no_rotation_age_recent(self):
    ...
    self.create_file(log_file, 2 * 1024 * 1024, 10)

    # rotate is size is >= 1Mo and age >=100s
  ...
  def test_no_rotation_size_small(self):
    ...
    self.create_file(log_file, 100, 1000)

    # rotate is size is >= 1Mo and age >=10s
