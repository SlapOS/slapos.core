...
class TestSlapgridWithDevPerm(MasterMixin, unittest.TestCase):
  ...
  def test(self):
    with self._mock_requests():
      ...
      called_list = [q for q in self.os_chown_call_list if q[0] == '/dev/tst']
      self.assertEqual(
        called_list,
        [
          ['/dev/tst', uid, gid],
  ...
  def test_long(self):
    with self._mock_requests():
      ...
      called_list = [q for q in self.os_chown_call_list if q[0] == '/dev/toolong']
      self.assertEqual(
        called_list,
        []
      )
  ...
  def test_not_existing(self):
    with self._mock_requests():
      ...
      called_list = [q for q in self.os_chown_call_list if q[0] == '/dev/non']
      self.assertEqual(
        called_list,
        []
      )
